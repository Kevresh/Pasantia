...
public class VentaRecoleccionServiceImpl implements VentaRecoleccionService {
    ...
    public ResponseEntity<?> crearVentaRecoleccion(ventaRecoleccionDTO VentaRecoleccionDTO) {
        try {
            Residuo residuo = residuoService.getResiduoById(VentaRecoleccionDTO.getIdResiduo());
            VentaRecoleccion ventaRecoleccion = new VentaRecoleccion(residuo,VentaRecoleccionDTO.getFechaFactura(), VentaRecoleccionDTO.getTotalKg(), VentaRecoleccionDTO.getValorUnitario(), VentaRecoleccionDTO.getResponsableCarga(), VentaRecoleccionDTO.getResponsableProceso());
